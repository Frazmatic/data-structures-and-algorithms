...
const sortNames = (arr) => {
  //could use something like "(a, b) => a.charCodeAt(0) - b.charCodeAt(0)" if that wasn't already default behavior of sort()
  return arr.sort();
};
...
const sortNumbers = (arr) => {
  //compare functions should return more positive if a > b, more negative if a < b
...
const alphabetize = (arr) => {
  //isn't this the same as Challenge 2? e.g. "'Cat' would come before 'apple'" is the same behavior.
  return arr.sort();
};
...
------------------------------------------------------------------------------------------------ */
//in python this would just be "arr.sort(key=lambda p: (p.last_name, p.first_name, p.age))" because it defaults to sorting tuples in order of element
...
//it worked but the linter doesn't like it :)
