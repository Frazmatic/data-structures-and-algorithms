...
//Is this supposed to be "joined *with* a space"?
const joinArray = (arr) => {
  return arr.join(' ');
};
...
//this one caught me up because I didn't notice the empty string at end of desired results
...
const listFoods = (recipe) => {
  ...
  for (let string of recipe.ingredients){
    ...
    result.push(string.slice(secondSpace + 1));
  }
  return result;
};
